...
class JdbcConfigurationProperties {
	...
	/**
	 * The database type to use. If not set, the type is detected from the {@link javax.sql.DataSource}. Configuring the
	 * type explicitly allows contexts without database access, such as CDS or AOT cache training runs, to bootstrap.
	 *
	 * @return can be {@literal null}.
	 * @since 2.2
	 */
