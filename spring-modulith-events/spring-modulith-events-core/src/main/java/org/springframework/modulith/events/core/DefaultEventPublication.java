...
/**
 * Default {@link TargetEventPublication} implementation.
 *
...
class DefaultEventPublication implements TargetEventPublication {
	...
	public String toString() {
		...
		return "DefaultEventPublication [event=" + event
	...
	public boolean equals(@Nullable Object obj) {
		...
		return Objects.equals(this.completionDate, that.completionDate) //
				...
				&& Objects.equals(this.lastResubmissionDate, that.lastResubmissionDate) //
				&& Objects.equals(this.completionAttempts, that.completionAttempts);
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(completionDate, event, publicationDate, targetIdentifier, status, lastResubmissionDate,
				completionAttempts);
	}
}
