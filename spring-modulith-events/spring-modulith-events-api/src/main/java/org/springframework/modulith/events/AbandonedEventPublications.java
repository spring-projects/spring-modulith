...
/**
 * All {@link EventPublication}s that have been abandoned, i.e. given up on after exhausting an application-defined
 * resubmission policy.
 *
 * @author Oliver Drotbohm
 * @since 2.2
 * @see EventPublication.Status#ABANDONED
 */
public interface AbandonedEventPublications {

	/**
	 * Returns all {@link EventPublication}s that have been abandoned.
	 *
	 ...
	 * all abandoned {@link EventPublication}s and apply the predicate in memory.
	 *
