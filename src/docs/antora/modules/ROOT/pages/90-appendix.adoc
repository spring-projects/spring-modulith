...
|`false`
|Whether to enable the xref:50-moments.adoc[`TimeMachine`].
...
|`spring-modulith-moments`|`compile`|The Passage of Time events implementation described xref:50-moments.adoc[here].
