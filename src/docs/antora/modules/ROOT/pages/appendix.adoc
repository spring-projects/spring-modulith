...
[NOTE]
====
By default, Hibernate maps UUID to BINARY(16) for MySQL.
To ensure correct Hibernate type mapping for UUID and avoid potential SQLExceptions at runtime, set the following property:
