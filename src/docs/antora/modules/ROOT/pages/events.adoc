...
For a more aggregate-driven approach to event publication, see https://docs.spring.io/spring-data/rest/reference/data-commons/repositories/core-domain-events.html[Spring Data's application event publication mechanism] for details.
