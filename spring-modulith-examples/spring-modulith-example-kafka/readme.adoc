...
22:20:21.277 D -     main : Registering publication of example.order.OrderCompleted for org.springframework.modulith.events.support.EventExternalizerModuleListener.externalize(java.lang.Object). <3>
...
22:20:21.376 D -   task-1 : Marking publication of event example.order.OrderCompleted to listener org.springframework.modulith.events.support.EventExternalizerModuleListener.externalize(java.lang.Object) completed. <6>
----
