...
class SpringModulithRuntimeAutoConfiguration {
	...
	static ApplicationModulesRuntime modulesRuntime(
			ApplicationRuntime runtime,
			SimpleAsyncTaskExecutorBuilder simpleAsyncTaskExecutorBuilder) {
		SimpleAsyncTaskExecutor asyncTaskExecutor = simpleAsyncTaskExecutorBuilder
				.threadNamePrefix("modulith-executor")
				.build();
		ThrowingSupplier<ApplicationModules> modules = () -> asyncTaskExecutor
